...
const SAVE_FORM = document.getElementById('saveForm'),
    ...
    NRC_CLIENTE = document.getElementById('NrcCliente'),
    TIPO_CLIENTE = document.getElementById('TipoCliente'),
    NOMBRECOMERCIAL_CLIENTE = document.getElementById('NombreCo'),
    CODIGO_CLIENTE = document.getElementById('CodigoCliente'),
